          ...
          <div className="rounded-[2rem] bg-white border border-blue-200 shadow-sm p-8 md:p-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-text-secondary">
                ...
                study activity, and the connected layers you&apos;ve already
                built.
              </p>
            </div>
            <Link
            ...
            {[
              {
                title: "Today",
                detail:
                  "A clear daily flow with one reading, one reflection, one prayer, and one challenge.",
                href: "/today",
                icon: NotebookPen,
              },
              {
                ...
                detail:
                  "Today’s study, reminders, streaks, and next steps in one home base.",
                href: "/dashboard",
                icon: TrendingUp,
              },
              {
                title: "AI studio",
                detail:
                  "A serious generation layer for study guides, devotionals, sermons, and quizzes.",
                href: "/ai-studio",
                icon: Brain,
              },
              {
                ...
                detail:
                  "Side-by-side wording across translations for deeper study.",
                href: "/translations",
                icon: Volume2,
              },
              {
                ...
                detail:
                  "Trusted commentary summaries alongside AI explanations.",
                href: "/commentaries",
                icon: Quote,
              },
              {
                title: "Voice mode",
                detail:
                  "Scripture audio, spoken Bible questions, and mobile-friendly listening flows.",
                href: "/voice",
                icon: Waves,
              },
              {
                ...
                detail:
                  "Whole-Bible progress tracking, yearly goals, and book-level milestones.",
              ...
              },
              {
                ...
                detail:
                  "Smarter suggestions for what to read, study, review, or pray next.",
              ...
              },
              {
                ...
                detail:
                  "Visual Scripture art, map previews, and richer geography-based study.",
                href: "/images",
                icon: Shapes,
              },
              {
                ...
                detail:
                  "XP, badges, daily quests, guided learning maps, and growth rewards.",
                href: "/gamification",
                icon: Target,
              },
              {
                title: "Fun layer",
                detail:
                  "Surprise studies, memory battles, seasonal challenges, and shareable win cards.",
                href: "/fun",
                icon: Sparkles,
              },
              {
                ...
                detail:
                  "Slow down the study flow and explain each verse with context and application.",
                href: "/verse-by-verse",
                icon: BookOpen,
              },
              {
                title: "Certificates",
                detail:
                  "Give guided paths and courses meaningful completion moments and rewards.",
                href: "/certificates",
                icon: CheckCircle,
              },
            ].map((item) => {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-lg leading-8 text-text-secondary">
                The build now points toward a more complete daily growth system:
                personalized study, guided paths, sermon support, group
                collaboration, publishing controls, trust systems, and
                mobile-first habit loops.
              </p>
            </div>
            <Link
              href="/today"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className="mt-4 text-lg text-text-secondary">
              The systems that make the product launch-ready, secure, reliable,
              and scalable.
            </p>
          </div>
            ...
            {[
              {
                ...
                detail:
                  "Operational checklist for billing, testing, analytics, and trust.",
                href: "/launch",
                icon: CheckCircle,
              },
              {
                title: "Permissions",
                detail:
                  "Role-based access, team seats, moderation, and entitlements.",
                href: "/permissions",
                icon: Users,
              },
              {
                ...
                detail:
                  "Make the dashboard, mentor, and recommendations adapt to the user.",
              ...
              },
              {
                ...
                detail:
                  "Production hardening through accessibility, testing, observability, and performance.",
                href: "/quality",
                icon: TrendingUp,
              },
              {
                ...
                detail:
                  "A portal for retention, content performance, funnel health, and operational visibility.",
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            <p className="mt-4 text-lg text-text-secondary">
              The strongest version of this app teaches, explains, compares, and
              guides instead of only linking pages together.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {[
              {
                title: "Bible Answers",
                detail:
                  "Big faith questions with key verses, clear summaries, and next passages to study.",
                href: "/questions",
                icon: Search,
              },
              {
                title: "Apologetics",
                detail:
                  "Resurrection, Scripture reliability, suffering, and worldview questions with biblical grounding.",
                href: "/apologetics",
                icon: Heart,
              },
              {
                title: "Topic Paths",
                detail:
                  "Study struggles and themes like anxiety, forgiveness, hope, prayer, and spiritual warfare.",
                href: "/topics",
                icon: Target,
              },
              {
                ...
                detail:
                  "A first discipleship path for the Gospel, prayer, Scripture habits, and Christian community.",
                href: "/new-believers",
                icon: Compass,
              },
              {
                title: "Reading Plans",
                detail:
                  "Structured plans for new believers, Gospel reading, Psalms and Proverbs, and whole-Bible goals.",
                href: "/reading-plans",
                icon: Calendar,
              },
            ].map((item) => {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card card-elevated group">
              ...
              <p className="text-text-secondary mb-4">
                Read God&apos;s Word in 3 translations (WEB, KJV, ASV) with
                beautiful formatting and easy navigation.
              </p>
              <Link
                href="/reading-plans"
                prefetch={false}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              New advanced layers for collaboration, personalization,
              orchestration, Scripture intelligence, and the systems that make
              the whole product compound.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Real-time rooms, shared prep, moderation, and church-team
                workflows.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Recommendation logic shaped by habits, goals, history, and
                tradition.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Guided flows from study to prayer, action, follow-up, and
                leadership prep.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Smarter cross-reference, theme, context, and mobile study
                layers.
              </p>
            </Link>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              The next stage is not just more tools. It is saved passage
              dashboards, publishing, mentor chat, permissions, mobile polish,
              and trust systems.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Save the whole study workspace around a passage, not just one
                note.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Add roles, invites, approvals, and safer collaboration for
                teams.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Push installability, offline reading, audio, and notification
                polish.
              </p>
            </Link>
            <Link
      ...
      <section className="py-20 bg-[#eef8ff]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              The killer feature is a personalized Bible learning path that
              guides people through Scripture step-by-step instead of leaving
              them to figure out where to start.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                AI-built weekly journeys through theology, gospel, discipleship,
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                A multi-panel environment for Bible text, explanation, notes,
                and questions.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Generate quick Bible quizzes from passages, paths, and doctrine
                modules.
              </p>
            </Link>
            <Link
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Save requests, revisit answered prayers, and track God&apos;s
                faithfulness.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-text-secondary">
                Preview voice mode, multilingual study, and shareable study
                cards.
              </p>
            </Link>
          </div>
          ...
          <div className="space-y-12">
            <div className="flex gap-8 items-start animate-fade-in">
              ...
              <div>
                ...
                <p className="text-lg text-text-secondary leading-relaxed">
                  Search any Bible passage above, or join one of our structured
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-text-secondary leading-relaxed">
                  Read Scripture, add notes and highlights, bookmark verses that
                  resonate with you, and reflect on what God is teaching.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-lg text-text-secondary leading-relaxed">
                  Build your daily reading streak, watch your progress on
                  reading plans, and see your spiritual growth in your
                  dashboard.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-surface">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-2xl md:text-3xl font-semibold text-text-primary mb-6 leading-relaxed">
            &quot;Knowing Jesus is the most important thing. This platform helps
            you study His Word deeply, stay consistent, and grow in faith, one
            passage at a time.&quot;
          </p>
          <p className="text-lg text-text-secondary">
            For personal study, groups, and churches
          </p>
        </div>
      </section>
