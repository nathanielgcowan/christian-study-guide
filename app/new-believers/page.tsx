...
import { getNewBelieverProgress, saveNewBelieverProgress } from "@/lib/persistence";
...
const programWeeks = [
  {
    ...
    focus: "Meet Jesus, understand His identity, and begin reading the Gospels with confidence.",
    memoryVerse: "John 1:12",
    prayerPrompt:
      "Jesus, help me see You clearly and trust who You are, not just what I assume about You.",
    actionStep: "Read one Gospel chapter slowly and write down one thing Jesus says or does that surprises you.",
    habits: ["Read one Gospel chapter each day", "Write one sentence about Jesus", "Pray before and after reading"],
    reflectionQuestions: [
    ...
    dailyReadings: [
      ...
      { day: "Day 2", reference: "John 1", label: "See Jesus as the Word made flesh" },
      { day: "Day 3", reference: "Mark 2", label: "Watch how Jesus responds to people" },
      { day: "Day 4", reference: "John 3", label: "Hear Jesus explain new birth" },
      { day: "Day 5", reference: "Mark 4", label: "Trust Jesus in fear and confusion" },
    ],
    checklist: [
  ...
  },
  {
    ...
    focus: "See sin, grace, the cross, and salvation by faith in a clear and simple way.",
    ...
    actionStep: "Write the Gospel in your own words using the themes of sin, grace, faith, and new life.",
    habits: ["Review one salvation passage each day", "Thank God for grace", "Ask one honest Gospel question"],
    reflectionQuestions: [
      "What does grace mean in real life, not just in theory?",
      "Where am I tempted to trust myself instead of Christ?",
    ],
    dailyReadings: [
      { day: "Day 1", reference: "Romans 3", label: "Understand the problem of sin" },
      { day: "Day 2", reference: "Romans 5", label: "See the love of God in Christ" },
      { day: "Day 3", reference: "Ephesians 2", label: "Receive grace by faith" },
      { day: "Day 4", reference: "Luke 15", label: "See the Father’s heart toward sinners" },
      { day: "Day 5", reference: "John 10", label: "Rest in the security of Jesus" },
    ],
    checklist: [
  ...
  },
  {
    ...
    focus: "Build a daily prayer rhythm with honest prayer, thanksgiving, and dependence on God.",
    memoryVerse: "Philippians 4:6-7",
    prayerPrompt:
      "Lord, teach me to bring my worries, thanks, and needs to You with trust and honesty.",
    actionStep: "Set a daily prayer time and save at least one prayer request in your journal this week.",
    habits: ["Pray in the morning", "Pray from one Psalm", "End the day with thanksgiving"],
    reflectionQuestions: [
      "What keeps me from praying honestly?",
      "What changes when I bring anxiety to God instead of carrying it alone?",
    ],
    dailyReadings: [
      { day: "Day 1", reference: "Matthew 6", label: "Learn from the Lord’s Prayer" },
      { day: "Day 2", reference: "Psalm 23", label: "Pray trust and dependence" },
      { day: "Day 3", reference: "Philippians 4", label: "Bring anxiety to God" },
  ...
  },
  {
    ...
    focus: "Learn context, observation, application, and how Scripture connects to Scripture.",
    ...
    actionStep: "Use the pattern observe, interpret, apply on one short passage and write down what you learn.",
    habits: ["Ask what the passage says", "Notice repeated words", "Write one application step"],
    reflectionQuestions: [
    ...
    dailyReadings: [
      ...
      { day: "Day 2", reference: "Luke 24", label: "See Jesus in the Scriptures" },
      { day: "Day 3", reference: "2 Timothy 3", label: "Trust Scripture’s purpose" },
      { day: "Day 4", reference: "Psalm 119", label: "Love the Word deeply" },
      { day: "Day 5", reference: "Acts 17", label: "Search the Scriptures carefully" },
    ],
    checklist: [
  ...
  },
  {
    ...
    focus: "Understand spiritual growth, conviction, fruit, and what it means to walk with the Spirit.",
    memoryVerse: "Galatians 5:22-23",
    prayerPrompt:
      "Holy Spirit, shape my desires, grow Your fruit in me, and help me walk in step with You.",
    actionStep: "Choose one fruit of the Spirit to pray for intentionally each day this week.",
    habits: ["Pray for the Spirit’s help", "Notice conviction quickly", "Practice one fruit intentionally"],
    reflectionQuestions: [
      "Where am I seeing new desires or conviction in my life?",
      "Which fruit of the Spirit do I most need God to grow right now?",
    ],
    dailyReadings: [
      { day: "Day 1", reference: "John 14", label: "Meet the Helper Jesus promised" },
      { day: "Day 2", reference: "Romans 8", label: "Walk by the Spirit" },
      { day: "Day 3", reference: "Galatians 5", label: "Study the fruit of the Spirit" },
  ...
  },
  {
    ...
    focus: "Step into Christian community, worship, service, and a sustainable discipleship rhythm.",
    memoryVerse: "Hebrews 10:24-25",
    prayerPrompt:
      "Lord, place me in healthy Christian community and help me encourage others as I grow.",
    actionStep: "Take one concrete step into community: join a group, attend church faithfully, or ask for a mentor.",
    habits: ["Show up consistently", "Ask for prayer", "Serve in one small way"],
    reflectionQuestions: [
      "Who is helping me grow in Christ right now?",
      "What next step into Christian community do I need to take this week?",
    ],
    dailyReadings: [
      { day: "Day 1", reference: "Acts 2", label: "See the life of the early church" },
      { day: "Day 2", reference: "Hebrews 10", label: "Stay connected to believers" },
      { day: "Day 3", reference: "Colossians 3", label: "Practice Christian community" },
      { day: "Day 4", reference: "1 Corinthians 12", label: "Understand the body of Christ" },
      { day: "Day 5", reference: "Romans 12", label: "Offer your life in service" },
    ],
    checklist: [
...
const coreHabits = [
  {
    ...
    detail: "Start with 10-15 minutes a day and focus on consistency before intensity.",
  },
  {
    title: "Simple prayer rhythm",
    detail: "Talk to God honestly, use Scripture in prayer, and keep a short list of requests and thanks.",
  },
  {
    title: "Weekly worship and community",
    detail: "Learn in the company of other believers, not only alone with your own questions.",
  },
  {
    title: "One next step of obedience",
    detail: "Every week should end with one concrete act of trust, not just more information.",
  },
];
...
const churchVocabulary = [
  { term: "Gospel", meaning: "The good news that Jesus saves sinners through His life, death, and resurrection." },
  { term: "Grace", meaning: "God's undeserved favor given to us in Christ, not something we earn." },
  { term: "Disciple", meaning: "A follower of Jesus who learns from Him and obeys Him." },
  { term: "Sanctification", meaning: "The ongoing process of God changing believers to become more like Jesus." },
];
...
function referenceToHref(reference: string) {
  return `/passage/${reference.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`;
}
...
export default function NewBelieversPage() {
        ...
        if (session) {
          ...
          if (data) {
            setProgress({
              ...
              currentWeekTitle: data.current_week_title || programWeeks[0]?.title || "",
  ...
  const handleAdvanceWeek = async () => {
    ...
    const nextWeekIndex = Math.min(progress.currentWeekIndex + 1, programWeeks.length - 1);
    ...
    await persistProgress(next, completed ? "Program completed" : "Advanced to next week");
  };
  ...
  const handleToggleDailyReading = async (weekTitle: string, reference: string) => {
  ...
  const currentWeek = programWeeks[progress.currentWeekIndex] || programWeeks[0];
  const currentWeekChecklist = progress.weekChecklists[currentWeek.title] || [];
  const currentWeekReadings = progress.dailyReadingsCompleted[currentWeek.title] || [];
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 text-lg leading-8 text-blue-100">
              This program gives new believers a simple structure for Scripture, prayer, habits,
              and community so they do not have to guess where to start.
            </p>
          </div>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-6xl px-6 py-14">
        <section className="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-semibold text-slate-900">Track your discipleship progress</h2>
              <p className="mt-2 text-sm leading-6 text-slate-600">
                Keep your current week, milestone progress, and mentor follow-up synced across devices when signed in.
              </p>
            </div>
            {saveFeedback ? (
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-4">
            <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Status</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">{progress.status}</p>
            </article>
            <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Current week</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">{currentWeek?.week || "Week 1"}</p>
            </article>
            <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Weeks completed</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">{progress.completedWeeks.length}</p>
            </article>
            <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Milestones checked</p>
              <p className="mt-2 text-lg font-semibold text-slate-900">{progress.completedMilestones.length}</p>
            </article>
          </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            >
              {progress.status === "completed" ? "Completed" : "Complete current week"}
            </button>
          </div>
        </section>
        ...
        <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="flex items-center gap-3 text-slate-900">
              ...
              <h2 className="text-2xl font-semibold">6-week discipleship path</h2>
            </div>
            <div className="mt-6 grid gap-4">
              {programWeeks.map((item) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm font-medium text-emerald-700">{item.reading}</p>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl border border-amber-200 bg-amber-50 p-8">
              <div className="flex items-center gap-3 text-amber-950">
                ...
                <h2 className="text-2xl font-semibold">Milestones that matter</h2>
              </div>
              <div className="mt-6 space-y-3">
                {milestones.map((item) => (
                  <button
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-blue-200 bg-blue-50 p-8">
            ...
            <div className="mt-6 rounded-3xl border border-blue-200 bg-white p-6">
              ...
              <h3 className="mt-2 text-2xl font-semibold text-slate-900">{currentWeek.title}</h3>
              <p className="mt-3 text-sm font-medium text-emerald-700">{currentWeek.reading}</p>
              <p className="mt-4 text-sm leading-6 text-slate-600">{currentWeek.focus}</p>

              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Memory verse</p>
                  <p className="mt-2 text-sm font-semibold text-slate-900">{currentWeek.memoryVerse}</p>
                </article>
                <article className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  <p className="text-xs font-semibold uppercase tracking-wide text-[#1e40af]">Action step</p>
                  <p className="mt-2 text-sm leading-6 text-slate-700">{currentWeek.actionStep}</p>
                </article>
              </div>

              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <article className="rounded-2xl border border-violet-200 bg-violet-50 p-5">
                  <p className="text-xs font-semibold uppercase tracking-wide text-violet-900">Prayer prompt</p>
                  <p className="mt-2 text-sm leading-6 text-violet-950">{currentWeek.prayerPrompt}</p>
                </article>
                <article className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
                  <p className="text-xs font-semibold uppercase tracking-wide text-amber-900">Habits to practice</p>
                  <div className="mt-2 space-y-2">
                    {currentWeek.habits.map((habit) => (
                      <p key={habit} className="text-sm leading-6 text-amber-950">
                        {habit}
                      </p>
                    ))}
                  </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  <div className="mt-4 space-y-3">
                    {currentWeek.dailyReadings.map((entry) => {
                      const completed = currentWeekReadings.includes(entry.reference);
                      return (
                        <div
                          key={entry.day}
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              ...
                              <p className="mt-2 text-sm leading-6 text-slate-600">{entry.label}</p>
                            </div>
                            <button
                              type="button"
                              onClick={() => handleToggleDailyReading(currentWeek.title, entry.reference)}
                    ...
                    {currentWeek.checklist.map((item) => {
                      ...
                      return (
                        <button
                          type="button"
                          key={item}
                          onClick={() => handleToggleChecklistItem(currentWeek.title, item)}
                          className={`block w-full rounded-2xl border p-4 text-left text-sm leading-6 transition ${
                            completed
                              ? "border-emerald-300 bg-emerald-100 text-emerald-950"
          ...
          <aside className="rounded-3xl border border-emerald-200 bg-emerald-50 p-8">
            <div className="flex items-center gap-3 text-emerald-950">
              <CheckCircle2 className="h-6 w-6" />
              <h2 className="text-2xl font-semibold">Questions to talk through this week</h2>
            </div>
            <div className="mt-6 space-y-3">
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-violet-200 bg-violet-50 p-8">
            <div className="flex items-center gap-3 text-violet-950">
              ...
              <h2 className="text-2xl font-semibold">Mentor support for common questions</h2>
            </div>
            <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <aside className="rounded-3xl border border-blue-200 bg-blue-50 p-8">
            <div className="flex items-center gap-3 text-blue-950">
              ...
              <h2 className="text-2xl font-semibold">Best next steps after this program</h2>
            </div>
            <div className="mt-6 space-y-4">
              {[
                ...
                { label: "Continue into foundations courses", href: "/courses" },
              ].map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <div className="flex items-center gap-3 text-slate-900">
              ...
              <h2 className="text-2xl font-semibold">Core habits for the first 30-60 days</h2>
            </div>
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              {coreHabits.map((habit) => (
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600">{habit.detail}</p>
                </article>
              ))}
            </div>
          </div>
          ...
          <aside className="rounded-3xl border border-amber-200 bg-amber-50 p-8">
            <div className="flex items-center gap-3 text-amber-950">
              <Milestone className="h-6 w-6" />
              <h2 className="text-2xl font-semibold">How this program connects to the rest of the app</h2>
            </div>
            <div className="mt-6 space-y-3">
              {[
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <aside className="rounded-3xl border border-violet-200 bg-violet-50 p-8">
            <div className="flex items-center gap-3 text-violet-950">
              <Sparkles className="h-6 w-6" />
              <h2 className="text-2xl font-semibold">Church vocabulary made simple</h2>
            </div>
            <div className="mt-6 space-y-3">
              {churchVocabulary.map((item) => (
                ...
                >
                  <p className="text-sm font-semibold text-violet-950">{item.term}</p>
        ...
        <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-semibold text-slate-900">Start with the foundations path</h2>
              <p className="mt-2 text-sm leading-6 text-slate-600">
                This program works best when it is connected to guided paths, prayer, memory work, and community.
              </p>
            </div>
